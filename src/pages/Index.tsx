...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section 
        className="relative flex min-h-[90vh] items-start justify-center bg-cover bg-center bg-no-repeat px-4 pt-4 pb-20"
        style={{
      ...
      >
        <div className="mx-auto max-w-4xl text-center mt-[80px]">
          {/* Logo */}
          <div className="mb-16 -mt-[60px] flex animate-fade-in justify-center">
            <img 
              src={bethelLogo} 
